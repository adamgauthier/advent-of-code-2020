...
[<Fact>]
let ``SolvePuzzlePartTwo WhenFirstExample ThenReturns8`` () =
    let result =
        Program.SolvePuzzlePartTwo ("16
10
15
5
1
...
[<Fact>]
let ``SolvePuzzlePartTwo WhenSecondExample ThenReturns19208`` () =
    let result =
        Program.SolvePuzzlePartTwo ("28
33
18
42
31
